        ...
        <div class="col-lg-10 col-md-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('user.update', $user->user_id) }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Nama -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">
                                        Kekuatan password: <span id="power-point" class="fw-bold">Masukkan min 6 karakter</span>
                                    </div>
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror

...
<div id="chatbot-box" class="card shadow d-none"
     style="position: fixed; bottom: 80px; right: 20px; width: 350px; max-width: 90%; z-index: 1050; height: 800px;">
    ...
    <div class="card-body" id="chatbox" style="max-height: 800px; overflow-y: auto;">
        <!-- Chat content here -->
    </div>
